...
namespace Drupal\inv_image_browser\Form;
...
class LibraryForm extends FormBase {
  ...
  public function getFormId() {
    return 'inv_image_browser_library_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['library'] = array(
      views_embed_view('inv_image_browser', 'image_browser'),
    );
    ...
    //$form['#attached']['library'][] = 'inv_image_browser/image_browser.view';
